...
import { MdAdd, MdHistory, MdChat, MdAssignment } from 'react-icons/md';
...
const SymptomChecker = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            setResult({
                conditions: [
                    { name: 'Common Cold', probability: 'High', details: 'Typical viral infection of the upper respiratory tract.' },
                    { name: 'Influenza (Flu)', probability: 'Medium', details: 'More severe symptoms including high fever and body aches.' },
                    { name: 'Seasonal Allergies', probability: 'Low', details: 'Reaction to environmental triggers like pollen.' }
                ],
                riskLevel: 'Low',
                suggestedActions: [
                ...
                suggestedTests: ['Physical exam', 'Rapid flu test (optional)']
            });
            setLoading(false);
